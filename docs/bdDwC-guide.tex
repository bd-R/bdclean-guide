...
and it corresponding DwC names.

\subsection{The Darwin Cloud
...
biodiversity data, via a user-friendly web interface. See
\protect\hyperlink{the-kurator-project}{The Kurator project} section for
more information.
...
operations \texttt{bdDwC} from the command line
...
\hypertarget{the-kurator-project}{\section{The Kurator
project}\label{the-kurator-project}}
